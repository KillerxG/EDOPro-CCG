...
public:
	...
	void ClearDummies();
	bool LoadLFListSingle(const epro::path_string& path, epro::wstringview prefix = L"");
	bool LoadLFListFolder(epro::path_stringview path, epro::wstringview prefix = L"");
	bool LoadGenesysListSingle(const epro::path_string& path, epro::wstringview prefix = L"");
	bool LoadGenesysFolder(epro::path_stringview path, epro::wstringview prefix = L"");
	void LoadLFList();
	void RefreshLFList();
