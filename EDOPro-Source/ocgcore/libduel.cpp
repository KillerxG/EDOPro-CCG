...
LUA_STATIC_FUNCTION(AnnounceRace) {
	...
	constexpr uint64_t LEGACY_OFFICIAL_RACE_ALL = (static_cast<uint64_t>(RACE_ILLUSION) << 1) - 1;
	if((available & LEGACY_OFFICIAL_RACE_ALL) == LEGACY_OFFICIAL_RACE_ALL)
		available |= RACE_YOKAI;
