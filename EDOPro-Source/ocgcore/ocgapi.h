...
OCGAPI int OCG_LoadScriptAllowAction(OCG_Duel ocg_duel, const char* buffer, uint32_t length, const char* name);
OCGAPI void OCG_DuelAdjustAll(OCG_Duel ocg_duel);
